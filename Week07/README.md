...
Напишете програма, която прочита двоично дърво от файл, проверява дали то е двоично дърво за търсене и след това записва дървото заедно с получения резултат в отделен файл. Дървото е представено във файла по следния начин: (корен (ляво поддърво...) (дясно поддърво...))

```
Дърво, представено във файла: (9 (4 (7 () ()) ()) (12 (6 (5 () ()) (8 () ())) (3 () (10 () ()))))
Конструирано дърво:
                     9
                   /   \
                  4     12
